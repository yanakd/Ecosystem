...
class Herbivore(pygame.sprite.Sprite, Animals):
    def __init__(self, width, height, pos_x, pos_y):
        ...
        self.preg = False
        self.caca = pygame.Rect(self.rect.x, self.rect.y, self.width, self.height)
    ...
    def defequer(self):
        if random.randrange(0,50) == 2:
            pygame.draw.rect(screen, brown, self.caca)
...
#-----------------------------Plants--------------------------------------------------
class Plants(pygame.sprite.Sprite, lifeforms):
    def __init__(self, width, height, pos_x, pos_y, color):
        lifeforms.__init__(self)
        pygame.sprite.Sprite.__init__(self)
        self.image = pygame.Surface([width, height]).convert_alpha()
        ...
        self.width = width
        self.height = height
        self.zoneSemis = pygame.Rect(self.rect.x-10, self.rect.y-10, self.width+60, self.height+60)
        self.zoneRacine = pygame.Rect(self.rect.x-10, self.rect.y-10, self.width+40, self.height+40)
...
def texts(): 
    ...
    NbrOfHerb = font.render("Number of herbivores:"+ str(number_of_Herbivores_alive+initial_Herbivores), 1,(255,255,255))
    NbrOfCarn = font.render("Number of Carnivores:"+ str(number_of_Carnivores_alive+initial_Carnivores), 1,(255,255,255))
    NbrOfPlant = font.render("Number of Plants:"+ str(number_of_Plants_alive+initial_Plants), 1,(255,255,255))
